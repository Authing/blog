---
title: 小程序扫码登录功能简介 | Authing 官方博客
description: Authing 小程序扫码登录功能简介
header: Authing 小程序扫码登录功能简介
---

小程序扫码登录指使用Authing小程序``身份管家``在网页端或其它客户端执行微信登录，目前的 SDK 仅支持客户端 JavaScript。

<!-- more -->

其它语言若想使用可参考[HTTP接口说明](https://docs.authing.cn/#/quick_start/wxapp_scan_login?id=http%E6%8E%A5%E5%8F%A3%E8%AF%B4%E6%98%8E)。
