---
title: 一行代码生成登录表单功能简介 | Authing 官方博客
description: Authing 一行代码生成登录表单功能简介
header: Authing 一行代码生成登录表单功能简介
---
...
代码开源，欢迎 star: [https://github.com/Authing/login-form](https://github.com/Authing/login-form)。
